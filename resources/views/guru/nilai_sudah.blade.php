...
<head>
    ...
    <title>Sudah Dinilai - Guru</title>
...
<div class="navbar">
    <div class="nav-left">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('guru.sudah') }}" class="active">Sudah Dinilai</a>
...
<div class="container">
    <div class="card">
        <h2>Daftar Siswa Sudah Dinilai</h2>
        <p style="margin-bottom:15px; color:#475569;">
            Total: <b>{{ count($nilai) }}</b> siswa sudah dinilai
        </p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('guru.nilai.get', $n->siswa->id) }}" class="btn-warning">
                        Edit
                    </a>
                </td>
            </tr>
